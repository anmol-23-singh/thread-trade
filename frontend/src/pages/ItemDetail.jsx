...
export default function ItemDetail() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-8 py-9">
      <button onClick={() => navigate('/listings')} className="text-sm text-ink/60 mb-4">
        ← Back to listings
      </button>
      <div className="flex gap-8 flex-wrap items-start">
        <div className="bg-paperRaised border border-ink/10 rounded-lg shadow-sm p-4 text-center w-64">
        ...
        <div className="flex-1 min-w-[280px]">
          ...
          <div className="flex gap-3 mt-5">
            {isMine ? (
              <span className="border border-ink/10 rounded-full px-4 py-2 text-sm">This is your own listing</span>
            ) : (
              <>
                <button
